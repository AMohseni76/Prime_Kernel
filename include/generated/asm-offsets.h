...
#define BL_POWER_UP_SETUP 8 /* offsetof(struct bL_power_ops, power_up_setup)	@ */
#define BL_SYNC_CLUSTER_SIZE 7 /* sizeof(struct bL_cluster_sync_struct)	@ */
#define BL_SYNC_CLUSTER_FIRST_MAN 6 /* offsetof(struct bL_cluster_sync_struct, first_man)	@ */
#define BL_SYNC_CLUSTER_CPUS 0 /* offsetof(struct bL_cluster_sync_struct, cpus)	@ */
#define BL_SYNC_CLUSTER_CLUSTER 4 /* offsetof(struct bL_cluster_sync_struct, cluster)	@ */
#define BL_SYNC_CLUSTER_INBOUND 5 /* offsetof(struct bL_cluster_sync_struct, inbound)	@ */
